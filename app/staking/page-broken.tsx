      ...
      <main className="bg-black-950 min-h-screen p-2 md:p-4">
        <div className="max-w-7xl mx-auto">
              ...
              <div className="bg-black-800 border border-black-700 rounded-lg p-6">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center space-x-3">
                    <span className="text-3xl">{selectedPoolData.icon}</span>
                    <div>
                      <h3 className="text-xl font-bold text-white">{selectedPoolData.name}</h3>
                      <p className="text-black-400">{selectedPoolData.description}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-2xl font-bold text-green-400">{selectedPoolData.apy}</div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  <div className="bg-black-900 border border-black-700 rounded-lg p-4 text-center">
                    <div className="text-lg font-bold text-white">{selectedPoolData.tvl}</div>
                    <div className="text-black-400 text-sm">Total Value Locked</div>
                  </div>
                  <div className="bg-black-900 border border-black-700 rounded-lg p-4 text-center">
                    <div className="text-lg font-bold text-white">{selectedPoolData.userStaked}</div>
                    <div className="text-black-400 text-sm">Your Stake</div>
                  </div>
                  <div className="bg-black-900 border border-black-700 rounded-lg p-4 text-center">
                    <div className="text-lg font-bold text-yellow-400">{selectedPoolData.rewards}</div>
                    <div className="text-black-400 text-sm">Pending Rewards</div>
                  </div>
                  <div className="bg-black-900 border border-black-700 rounded-lg p-4 text-center">
                    <div className="text-lg font-bold text-purple-400">{userVePRED.toFixed(2)}</div>
                    <div className="text-black-400 text-sm">vePRED Power</div>
                  </div>
                </div>
          ...
          <div className="bg-gradient-to-r from-purple-900/20 to-blue-900/20 border border-purple-700 rounded-lg p-6">
            <h3 className="text-purple-400 font-bold text-lg mb-4">🎯 Staking Benefits</h3>
